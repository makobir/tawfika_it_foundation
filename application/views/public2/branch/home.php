         <section>
            <div class="sptb-2 sptb-tab">
               <div class="header-text mb-0">
                  <div class="container">
                     <div id="myCarousel" class="carousel slide" data-ride="carousel" style=" margin: -110px 0px;height: 600px;">
              <!-- Indicators -->
                          ...
                          <div class="carousel-inner" style="height: 600px;">
                            ...
                            <div class="item">
                              <img src="<?= base_url() ?>upload/slider/2.jpg" alt="Chicago">
                            </div>

                            <div class="item">
                              <img src="<?= base_url() ?>upload/slider/3.jpg" alt="New York">
                            </div>
                          </div>
            ...
            <div class="item-all-cat center-block text-center education-categories">
               <div class="row">
                  ...
                  <div class="col-lg-2 col-md-4 col-sm-6">
                     <div class="item-all-card text-dark text-center">
                        <a href="page-list.html"></a> 
                        <div class="iteam-all-icon"> <i class="fe fe-database gradient-icon"></i> </div>
                        <div class="item-all-text mt-3">
                  ...
                  <div class="col-lg-2 col-md-4 col-sm-6">
                     <div class="item-all-card text-dark text-center">
                        <a href="page-list.html"></a> 
                        <div class="iteam-all-icon"> <i class="fa fa-balance-scale gradient-icon  fa-3x"></i> </div>
                        <div class="item-all-text mt-3">
                           <h5 class="mb-0">Law</h5>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-2 col-md-4 col-sm-6">
                  ...
                  <div class="col-lg-2 col-md-4 col-sm-6">
                     <div class="item-all-card text-dark text-center mb-lg-0">
                        <a href="page-list.html"></a> 
                        <div class="iteam-all-icon"> <i class="fe fe-briefcase gradient-icon "></i> </div>
                        <div class="item-all-text mt-3">
                  ...
                  <div class="col-lg-2 col-md-4 col-sm-6">
                     <div class="item-all-card text-dark text-center mb-lg-0">
                        <a href="page-list.html"></a> 
                        <div class="iteam-all-icon"> <i class="fe fe-book gradient-icon"></i> </div>
                        <div class="item-all-text mt-3">
                  ...
                  <div class="owl-stage" style="transform: translate3d(-1201px, 0px, 0px); transition: all 0.25s ease 0s; width: 3904px;">
                        ...
                        <div class="item">
                           <div class="card mb-0">
                              ...
                              <div class="item-card2-img">
                                 <a href="page-details.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/5.jpg" alt="img" class="cover-image"> 
                                 <div class="item-tag">
                              ...
                              <div class="item-card2-icons"> <a href="#" class="item-card2-icons-l"> <i class="fa fa-share-alt"></i></a> <a href="page-details.html" class="item-card2-icons-l "> <i class="fa fa-heart-o"></i></a> </div>
                              <div class="card-body">
                                 <div class="item-card2">
                                    <div class="item-card2-desc">
                                       <div class="item-card2-text mb-3">
                                          <a href="page-details.html" class="text-dark">
                                             <h4 class="mb-2">Guitar classes at home</h4>
                                          </a>
                                       </div>
                                       ...
                                       <ul class="mb-0">
                                          ...
                                          <li><a href="#" class="icons"><i class="icon icon-user mr-1"></i> Sally Peake</a></li>
                              ...
                              <div class="card-footer">
                                 <div class="item-card2-footer"> <a class="btn btn-outline-light"><span class="font-weight-bold"><i class="fa fa-calendar"></i> :</span> 9 Months</a> <a class="btn btn-primary text-white float-right"><span class="font-weight-bold"><i class="fa fa-clock-o"></i> :</span> 4 Hours</a> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="owl-item cloned" style="width: 275.252px; margin-right: 25px;">
                        <div class="item">
                           <div class="card mb-0">
                              <div class="item-card2-img">
                                 <a href="page-details.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/1.jpg" alt="img" class="cover-image"> 
                                 <div class="item-tag">
                              ...
                              <div class="card-footer">
                                 <div class="item-card2-footer"> <a class="btn btn-outline-light"><span class="font-weight-bold"><i class="fa fa-calendar"></i> :</span> 9 Months</a> <a class="btn btn-primary text-white float-right"><span class="font-weight-bold"><i class="fa fa-clock-o"></i> :</span> 2 Hours</a> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="owl-item cloned" style="width: 275.252px; margin-right: 25px;">
                        <div class="item">
                           <div class="card mb-0">
                              <div class="item-card2-img">
                                 <a href="page-details.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/18.jpg" alt="img" class="cover-image"> 
                                 <div class="item-tag">
                                 ...
                                 <div class="item-card2">
                                    <div class="item-card2-desc">
                                       <div class="item-card2-text">
                                          <a href="page-details.html" class="text-dark">
                                             <h4 class="mb-2">3D Animation Trainig</h4>
                                          </a>
                                       </div>
                                       <p class="">At vero eos et accusamus et iusto odio dignissimos ducimus </p>
                                       <ul class="mb-0">
                     ...
                     <div class="owl-item cloned" style="width: 275.252px; margin-right: 25px;">
                        <div class="item">
                           <div class="card mb-0">
                              <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                              <div class="item-card2-img">
                                 <a href="page-details.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/12.jpg" alt="img" class="cover-image"> 
                                 <div class="item-tag">
                              ...
                              <div class="card-footer">
                                 <div class="item-card2-footer"> <a class="btn btn-outline-light"><span class="font-weight-bold"><i class="fa fa-calendar"></i> :</span> 9 Months</a> <a class="btn btn-primary text-white float-right"><span class="font-weight-bold"><i class="fa fa-clock-o"></i> :</span> 3 Hours</a> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     <div class="owl-item active" style="width: 275.252px; margin-right: 25px;">
                        <div class="item">
                           <div class="card mb-0">
                              <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                              <div class="item-card2-img">
                                 <a href="page-details.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/6.jpg" alt="img" class="cover-image"> 
                                 <div class="item-tag">
                              ...
                              <div class="item-card2-icons"> <a href="page-details.html" class="item-card2-icons-l"> <i class="fa fa-share-alt"></i></a> <a href="page-details.html" class="item-card2-icons-l"> <i class="fa fa-heart text-danger"></i></a> </div>
                              <div class="card-body">
                                 <div class="item-card2">
                                    <div class="item-card2-desc">
                                       <div class="item-card2-text mb-3">
                                          <a href="page-details.html" class="text-dark">
                                             <h4 class="mb-2">Coding Classes</h4>
                                          </a>
                                       </div>
                                       <p class="">At vero eos et accusamus et iusto odio dignissimos ducimus </p>
                                       <ul class="mb-0">
                              ...
                              <div class="card-footer">
                                 <div class="item-card2-footer"> <a class="btn btn-outline-light"><span class="font-weight-bold"><i class="fa fa-calendar"></i> :</span> 9 Months</a> <a class="btn btn-primary text-white float-right"><span class="font-weight-bold"><i class="fa fa-clock-o"></i> :</span> 1 Hour</a> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="owl-item" style="width: 275.252px; margin-right: 25px;">
                        <div class="item">
                           <div class="card mb-0">
                              <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                              <div class="item-card2-img">
      ...
      <!--/Section--> <!--Section--> 
      <section>
         <div class="about-1 cover-image sptb bg-background-color" data-image-src="<?php echo base_url() ?>assets/branch/images/banners/banner5.jpg" style="background: url(&quot;<?php echo base_url() ?>assets/branch/images/banners/banner5.jpg&quot;) center center;">
               ...
               <div class="">
                  <div class="tabs-menu ">
                     ...
                     <ul class="nav panel-tabs eductaional-tabs mb-6">
                        <li class=""><a href="#tab1" class="active show" data-toggle="tab">All</a></li>
                        <li><a href="#tab2" data-toggle="tab" class="">Short Term Courses</a></li>
                        <li><a href="#tab3" data-toggle="tab" class="">Long Term Courses</a></li>
                        <li><a href="#tab4" data-toggle="tab" class="">Online Courses</a></li>
                     </ul>
                  </div>
               </div>
                           ...
                           <div class="col-xl-4 col-md-6">
                              <div class="card overflow-hidden">
                                 ...
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/12.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext"> <a href="education.html" class="text-white"> Marketing</a> </div>
                                 </div>
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       <div class="item-card7-text">
                                          <a href="education.html" class="text-dark">
                                             <h3 class="font-weight-semibold">Digital Marketing</h3>
                                          </a>
                                       </div>
                                 ...
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span> <span class="text-muted">6 Months</span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span><span class="text-muted"> 2 Hours </span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block">Join Free</a> </div>
                              </div>
                           </div>
                           <div class="col-xl-4 col-md-6">
                              <div class="card overflow-hidden">
                                 <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/6.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white"> IT</a> 
                                       <h4 class="mb-0">$752.99</h4>
                                    </div>
                                 </div>
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       <div class="item-card7-text">
                                          <a href="education.html" class="text-dark">
                                             <h3 class="font-weight-semibold"> Coding Training Classes</h3>
                                          </a>
                                       </div>
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i> London</a></li>
                                          <li><a href="#" class="icons text-muted"><i class="icon icon-event  mr-1"></i>10 mins ago</a></li>
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-phone  mr-1"></i> 14 675 65</a></li>
                                       </ul>
                                       <p class="mb-0">Nemo enim ipsam voluptatem voluptas sit aspernatur ratione voluptatem sequi nesciunt..</p>
                                    </div>
                                 </div>
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span><span class="text-muted">9 Months</span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span><span class="text-muted"> 1 Hour</span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block">Join Now</a> </div>
                              </div>
                           </div>
                           <div class="col-xl-4 col-md-6">
                              <div class="card overflow-hidden">
                                 <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/5.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white"> Degree</a> 
                                 ...
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       ...
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i>Canada</a></li>
                                          <li><a href="#" class="icons text-muted"><i class="icon icon-event  mr-1"></i>15 mins ago</a></li>
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-phone  mr-1"></i> 14 675 65</a></li>
                                       </ul>
                                       <p class="mb-0">Nemo enim ipsam voluptatem voluptas sit aspernatur ratione voluptatem sequi nesciunt..</p>
                                    </div>
                                 </div>
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span> <span class="text-muted">3 Months</span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span> <span class="text-muted">3 Hour</span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block">Join Now</a> </div>
                              </div>
                           </div>
                           <div class="col-xl-4 col-md-6">
                              <div class="card overflow-hidden mb-xl-0">
                                 <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/7.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white"> Literature</a> 
                                 ...
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       <div class="item-card7-text">
                                          <a href="education.html" class="text-dark">
                                             <h3 class="font-weight-semibold">Free Literature Classes</h3>
                                          </a>
                                       </div>
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i> London</a></li>
                                 ...
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span><span class="text-muted"> 2 Months </span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span><span class="text-muted"> 2 Hours</span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block">Join Now</a> </div>
                              </div>
                           </div>
                           <div class="col-xl-4 col-md-6">
                              <div class="card mb-md-0">
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/8.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white">Photoshop</a> 
                                 ...
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       <div class="item-card7-text">
                                          <a href="education.html" class="text-dark">
                                             <h3 class="font-weight-semibold">PhotoShop Designing</h3>
                                          </a>
                                       </div>
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i> USA</a></li>
                                          <li><a href="#" class="icons text-muted"><i class="icon icon-event  mr-1"></i>1 hour ago</a></li>
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-phone  mr-1"></i> 14 675 65</a></li>
                                       </ul>
                                       <p class="mb-0">Nemo enim ipsam voluptatem voluptas sit aspernatur ratione voluptatem sequi nesciunt..</p>
                                    </div>
                                 </div>
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span><span class="text-muted"> 3 Months</span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span><span class="text-muted"> 8 Hours</span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block">Join Now</a> </div>
                              </div>
                           </div>
                           <div class="col-xl-4 col-md-6">
                              <div class="card mb-0">
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/9.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white">Networking</a> 
                                 ...
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       ...
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i>India</a></li>
                                          <li><a href="#" class="icons text-muted"><i class="icon icon-event  mr-1"></i>15 mins ago</a></li>
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-phone  mr-1"></i> 14 675 65</a></li>
                                       </ul>
                                       <p class="mb-0">Nemo enim ipsam voluptatem voluptas sit aspernatur ratione voluptatem sequi nesciunt..</p>
                                 ...
                                 <div class="card-body p-4 pl-5"> <a class="mr-4"><span class="font-weight-bold">Duration :</span> <span class="text-muted"> 6 Months</span></a> <a class="mr-4 float-right"><span class="font-weight-bold">Daily :</span> <span class="text-muted">3 Hours</span></a> </div>
                                 <div class="card-body"> <a href="education.html" class="btn btn-primary btn-block"><span class="">Join Now</span></a> </div>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="row">
                           <div class="col-xl-4 col-md-6">
                              <div class="card overflow-hidden mb-0">
                                 <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><i class="fa fa-bolt"></i></span></div>
                                 <div class="item-card7-img">
                                    <div class="item-card7-imgs"> <a href="education.html"></a> <img src="<?php echo base_url() ?>assets/branch/images/media/pictures/10.jpg" alt="img" class="cover-image"> </div>
                                    <div class="item-card7-overlaytext">
                                       <a href="education.html" class="text-white"> App Developer</a> 
                                 ...
                                 <div class="card-body">
                                    <div class="item-card7-desc">
                                       <div class="item-card7-text">
                                          <a href="education.html" class="text-dark">
                                             <h3 class="font-weight-semibold">App Development Classes</h3>
                                          </a>
                                       </div>
                                       <ul class="d-flex mb-2">
                                          <li class=""><a href="#" class="icons text-muted"><i class="icon icon-location-pin  mr-1"></i> London</a></li>
