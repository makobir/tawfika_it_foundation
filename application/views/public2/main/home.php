                    ...
                    <div id="rev_slider_1_1" class="rev_slider fullwidthabanner disp_none height_630 max-height_630">
                        <ul>
                            ...
                            <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                                <img src="<?= base_url() ?>assets/main/images/green.jpg" alt="green" data-bgposition="center top" data-bgfit="normal" data-bgrepeat="repeat">
                            ...
                            <!-- Slide 2 -->
                            <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                                <img src="<?= base_url() ?>assets/main/images/blue.jpg" alt="blue" data-bgposition="center top" data-bgfit="normal" data-bgrepeat="repeat">
                            ...
                            <!-- Slide 3 -->
                            <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
                                <img src="<?= base_url() ?>assets/main/images/yellow.jpg" alt="yellow" data-bgposition="center top" data-bgfit="normal" data-bgrepeat="repeat">
                ...
                <div class="content">
                    <article class="post_item post_item_single page">
						<section class="post_content">
										...
										<div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
											...
											<div class="sc_blogger layout_courses_3 template_portfolio sc_blogger_horizontal no_description">
												<div class="isotope_wrap" data-columns="3">
													<?php foreach ($this->Home_model->frontcourse() as $key => $course) { ?>
													<!-- Courses item -->
							...
							<div class="sc_section post_ts_bg3"  data-animation="animated fadeInUp normal" >
								<h3 class="sc_title sc_title_regular aligncenter" style="color: white; font-weight:bold; padding-top: 10px;">
									<img style="height: 80px;" src="<?= base_url() ?>upload/site_img/admission.png">
									<a  href="">Admission Going On</a>
								</h3>
							</div>
											...
											<div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
												<div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center">
													<div class="sc_price_block sc_price_block_style_1 width_100per">
														<div class="sc_price_block_title">Managing Director's Speach </div>
														...
														<div class="sc_price_block_link">
															<a href="product-page.html" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small">Read More</a>
														</div>
													</div>
												</div>
												<div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center">
