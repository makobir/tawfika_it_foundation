  ...
  <div class="cover-image bg-background3" data-image-src="<?= base_url() ?>upload/slider/2.jpg" style="background: url(&quot;<?= base_url() ?>upload/slider/2.jpg&quot;) center center;">
   <div class="header-main">
               ...
               <div class="col-xl-4 col-lg-4 col-sm-8 col-5">
                  <div class="top-bar-right">
                     <ul class="custom">
                        ...
                        <li> <a href="<?= base_url() ?>home/login" class="text-dark"><i class="fa fa-sign-in mr-1"></i> <span>Login</span></a> </li>
                        <?php } else { ?>
                        <li class="dropdown">
      ...
      <div id="sticky-wrapper" class="sticky-wrapper" style="height: 50.9896px;">
         <div class="header-style horizontal-main bg-dark-transparent clearfix" style="width: 1349px;">
            <div style="margin-left: 59px" class="horizontal-mainwrapper container clearfix">
               <nav class="horizontalMenu clearfix d-md-flex">
                  ...
                  <ul class="horizontalMenu-list">
                     ...
                     <li aria-haspopup="true">
                        ...
                        <ul class="sub-menu">
                            <?php foreach($this->Home_model->allcourses() as $course ) { ?>
                                <li><a href="<?php echo base_url().'home/course_details/'.$course->id; ?>"><?php echo $course->title; ?></a></li>
                           <?php } ?>
                        </ul>
                     </li>
                     <li aria-haspopup="true" class="">
                     ...
                     <li aria-haspopup="true" class="">
                        <a href="<?= base_url() ?>home/result" class="<?php if($title == 'News') {echo 'active'; }?>">Result</a>
                     </li>
                     <li aria-haspopup="true" class="">
                  ...
                  <ul class="mb-0">
                     <li style="margin-right: -16px;" aria-haspopup="true" class="d-none d-lg-block "> <span><a class="btn btn-primary  ad-post" href="#">Enroll Now</a></span> </li>
                  </ul>
               </nav>
            </div>
         </div>
             ...
             <div class="latest-m">
                <marquee direction="left" onmouseover="stop()" onmouseout="start()" scrolldelay="120"> 
                  <?php foreach ($this->Home_model->front_notice() as $key => $value) { ?>
                   <i class="fas fa-caret-right" style="color: #fff; margin-right: 20px;"></i>&nbsp; <a href="<?= base_url() ?>home/notice_detail/<?= $value->id; ?>"><?= $value->title; ?></a>
                  <?php } ?>
                </marquee>
             </div>
          </div>
...
<?php } ?>
                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-2 col-md-12">
                        ...
                        <ul class="list-unstyled mb-0">
                           ...
                           <li><a href="<?= base_url() ?>home/allcourse">Courses</a></li>
                           <li><a href="<?= base_url() ?>home/terms">Terms and Services</a></li>
                        </ul>
                     </div>
                     <div class="col-lg-3 col-md-12">
                        <h6>Contact</h6>
                        <hr class="deep-purple  text-primary accent-2 mb-4 mt-0 d-inline-block mx-auto">
                        <ul class="list-unstyled mb-0">
                           <li> <a href="#"><i class="fa fa-home mr-3 text-primary"></i><?= $site->address; ?></a> </li>
                           <li> <a href="#"><i class="fa fa-envelope mr-3 text-primary"></i> <?= $site->email; ?></a></li>
                           <li> <a href="#"><i class="fa fa-phone mr-3 text-primary"></i> <?= $site->mobile; ?></a> </li>
                        </ul>
                     ...
                     <div class="col-lg-4 col-md-12">
                        ...
                        <div class="input-group w-100">
                           <input style="height: 37px !important;" type="text" class="form-control br-tl-3  br-bl-3 " placeholder="Email"> 
            ...
            <div class="bg-dark  text-white p-0">
               <div class="container">
                  <div class="row d-flex">
                     <div class="col-lg-12 col-sm-12 mt-3 mb-3 text-center "> Copyright © 2021 <a href="https://tif.org.bd/" class="fs-14 text-primary">Tawfika IT Foundation </a>. Design & Developed by <a href="https://fb.com/makobirbd" class="fs-14 text-primary"> Md. Alamgir Kobir </a> All rights reserved. </div>
                  </div>
               </div>
            </div>
         </footer>
      ...
      <script src="<?php echo base_url() ?>assets/branch/horizontal-menu.js"></script><script type="text/javascript"><!--
