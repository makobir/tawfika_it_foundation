                  ...
                  <div class="row content">
                     ...
                     <div class="col-md-12 right-content">
                        ...
                        <div data-form-validation="true" >
                           <form action="<?= base_url() ?>home/verify_cert" id="domainSearchForm" enctype="multipart/form-data" method="post" accept-charset="utf-8">                                       
                              <div class="row reset-gutter" >
                                ...
                                <div class="col-sm-2">
                                 ...
                                 <div class="col-sm-3">
                                    <input class="form-control" name="certificate_number" type="text" placeholder="সনদপত্র/প্রত্যয়ন নম্বর" required>
                                 </div>
                                            
                                <div class="col-sm-3 select-box">
                                    <select class="form-control" name="certificate_type" required>
                                        <option selected="" disabled="">সনদপত্র/নাগরিক নির্বাচন করুন</option>
                                        <option value="2">সনদপত্র</option>
                                        <option value="1">নাগরিক তথ্য</option>
                                        
                                    </select>
                                </div>
                                 <div class="col-sm-2">
                                    <button class="btn submit-button-custom" type="submit"> <i class="fa fa-search"></i>   যাচাই</button>
                                 </div>
                             </div>
                           </form>
                        </div>
