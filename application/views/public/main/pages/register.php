      ...
      <div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
        ...
        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
          ...
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            ...
            <input style="border:1px solid #676774; width: 100%;" type="text" id="institute" name="institute" required>
          </div>
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            <label for="fname">CEO / Director Name</label><br>
            <input style="border:1px solid #676774; width: 100%;" type="text" id="director" name="director" required>
          </div>
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            <label for="fname">Address</label><br>
            <input style="border:1px solid #676774; width: 100%;" type="text" id="address" name="address" required>
          </div>
        <!-- 
                    <div class="form-group">
          ...
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            ...
            <input style="border:1px solid #676774; width: 100%;" type="text" id="email" name="email" required>
            <span id="email_result"></span> 
          </div>
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            <label for="fname">Mobile</label><br>
            <input style="border:1px solid #676774; width: 100%;" type="text" id="mobile" name="mobile" placeholder="017XXXXXXXX" minlength="11" maxlength="11" required>
            <span id="mobile_result"></span> 
          </div>

          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            <label for="fname">Domain for Website</label><br>
            <input style="border:1px solid #676774; width: 100%;" type="text" id="domain" name="domain" placeholder="Ex. tawfika.com">
            <span id="mobile_result"></span> 
          </div> 
          <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
            <label for="fname">Refferal Code</label><br>
            <input style="border:1px solid #676774; width: 100%;" type="text" id="refferal" name="refferal" placeholder="Center Code as Refferal Code ">
            <span id="mobile_result"></span> 
          </div>
