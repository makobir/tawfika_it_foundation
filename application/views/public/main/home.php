      ...
      <div id="rev_slider_1_1" class="rev_slider fullwidthabanner disp_none height_630 max-height_630">
         <ul>
            ...
            <li data-transition="random" data-slotamount="7" data-masterspeed="300" data-saveperformance="off">
               <img src="<?= base_url() ?>upload/slider/slider.jpg" alt="green" data-bgposition="center top" data-bgfit="normal" data-bgrepeat="repeat">
   ...
   <div class="content">
      <article class="post_item post_item_single page">
         <section class="post_content">
                  ...
                  <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                     <div class="column-1_2 sc_column_item sc_column_item_1 odd first res_width_100per_imp">
                        <h3 class="sc_title sc_title_iconed sc_align_left text_left">
                           To be an Associate Member by affiliate your Training Center
                        </h3>
                        <p>Join us to build skilled manpower. Trained up the poor meritorious people in vocational education through scholarships. </p>
                        <a href="<?= base_url()?>home/registration" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_mini sc_button_iconed inherit margin_top_1em margin_bottom_4 margin_left_4">Register Now</a>
                     </div>
                     <div class="column-1_2 sc_column_item sc_column_item_2 even res_width_100per_imp">
                        <div class="sc_video_player sc_video_bordered sc_video_st1">
                           <div class="sc_video_frame sc_video_play_button hover_icon hover_icon_play width_100per" data-width="100%" data-height="647" data-video="&lt;iframe class=&quot;video_frame&quot; src=&quot;http://youtube.com/embed/636Dp8eHWnM?autoplay=1&quot; width=&quot;100%&quot; height=&quot;647&quot; frameborder=&quot;0&quot; webkitAllowFullScreen=&quot;webkitAllowFullScreen&quot; mozallowfullscreen=&quot;mozallowfullscreen&quot; allowFullScreen=&quot;allowFullScreen&quot;&gt;&lt;/iframe&gt;">
                              <img width="400px" height : "225px" alt="" src="<?= base_url()?>upload/scholarship/aff.png">
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="sc_section accent_top bg_tint_light sc_bg1" data-animation="animated fadeInUp normal">
               <div class="sc_section_overlay">
                  <div class="sc_section_content">
                     <div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
                        <h2 style="font-weight:bold; text-align:center;" class="sc_title sc_title_regular sc_align_center margin_top_0 margin_bottom_085em text_center">
                           Popular Courses 
                           <hr style="border:2px solid green; width:80px; background: green;">
                        </h2>
                                 ...
                                 <div class="post_item post_item_courses odd">
                                    <div class="post_content isotope_item_content ih-item colored square effect_dir left_to_right">
                                       <div class="post_featured img">
                                          <a href="<?= base_url() ?>home/course_details/<?= $course->id; ?>">
                                             <img alt="" src="<?= base_url() ?>upload/course/<?php echo $course->userfile ; ?>">
                                          </a>
                                          <h4 class="post_title">
                                          ...
                                          <div class="post_descr">
                                             <div class="post_price">
                                                <span class="post_price_value">৳ <?php echo $course->course_fee ; ?></span>
                                                <!-- <span class="post_price_period"><?php echo $course->duration ; ?> </span> -->
                                             </div>
                                             <div class="post_category">
                                                <a href="#"><?php echo $course->duration ; ?> Months</a>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="post_info_wrap info">
                                          <div class="info-back">
                                             <h4 class="post_title">
                                                <a href="<?= base_url() ?>home/course_details/<?= $course->id; ?>"><?php echo $course->title ; ?></a>
                                             </h4>
                                             <div class="post_descr">
                                                <p>
                                                   <a href="<?= base_url() ?>home/course_details/<?= $course->id; ?>"><?php echo $course->short ; ?></a>
                                                </p>
                                                <div class="post_buttons">
                                                   ...
                                                   <div class="post_button">
                                                      <a href="<?= base_url() ?>home/course_details/<?= $course->id; ?>" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small">BUY NOW</a>
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                        ...
                        <a href="<?= base_url() ?>home/allcourse" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_menu sc_button_size_small aligncenter sc_button_iconed icon-graduation margin_top_1em margin_bottom_4 widht_12em">VIEW ALL COURSES</a>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="sc_section accent_top bg_tint_light sc_bg1" data-animation="animated fadeInUp normal">
               <div class="sc_section_overlay">
                  <div class="sc_section_content">
                     <div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                           <div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center" style=" text-align:center;">
                                <img style="height: 200px;" src="<?= base_url() ?>upload/site_img/admission.png">
                           </div>
                           <div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center" style="padding-top:50px; text-align:center;">
                             Be skilled with a skill development training with us. You can chose a nearest affiliated institute.<br>
                             <a class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_mini sc_button_iconed inherit margin_top_1em margin_bottom_4 margin_left_4" style="padding-top: 20px;" href="<?= base_url() ?>home/admission">Admission Going On</a>
            ...
            <div class="sc_section"  data-animation="animated fadeInUp normal" style="padding:100px 0px; background: #F89009 !important" >
                <p style="color: white; font-weight: bold;text-align:center;">We are growing day by day with our honorable partners. Thanks all for contributing. Tawfika IT Foundation</p>
                <section class="counters" style="background: #F89009 !important">
                    <div class="tac">
                        <i class="fab fa-youtube fa-4x"></i>
                        <div class="counter" data-target="300">0</div>
                        <h4>Total Afiliated Center</h4>
                    </div>
                    <div class="cex">
            ...
            <div class="sc_section scholarship_bg"  data-animation="animated fadeInUp normal" >
               <h3 class="sc_title sc_title_regular aligncenter" style="color: white; font-weight:bold; padding-top: 10px;">
                  <img style="height: 80px;" src="<?= base_url() ?>upload/site_img/Graduation-Scholarship-PNG-File.png">
                  <a  href="<?= base_url() ?>upload/scholarship/Scholarship_Application_Form.pdf">Get Scholarship Form </a>
               </h3>
            </div>
            ...
            <div class="sc_section accent_top bg_tint_light sc_bg1" data-animation="animated fadeInUp normal">
               <div class="sc_section_overlay">
                  <div class="sc_section_content">
                     <div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
                        <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                           <div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center">
                              <div class="sc_price_block sc_price_block_style_1 width_100per">
                                 <div class="sc_price_block_title">Founder Speach </div>
                                 <div class="sc_price_block_money">
                                    <img style="width: 188px" src="<?= base_url() ?>upload/logo/logo.png">
                                 </div>
                                 ...
                                 <div class="sc_price_block_link">
                                    <a href="<?= base_url() ?>home/founder_detail" class="sc_button sc_button_square sc_button_style_filled sc_button_bg_link sc_button_size_small">Read More</a>
                                 </div>
                              </div>
                           </div>
                           <div class="column-1_2 sc_column_item sc_column_item_1 odd first text_center">
...
<!-- /Testimonials footer --><!-- Partners section -->
<!--<div class="sc_section" data-animation="animated fadeInUp normal">
   <div class="sc_content content_wrap margin_top_2_5em_imp margin_bottom_2_5em_imp">
