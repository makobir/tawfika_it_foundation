...
if($res_count == 0) { ?>
  ...
  <div class="card card-primary card-outline" style="margin-top:20px;">    
      <div class="card-body">  
        ...
        <form method="post" action="<?php echo base_url();?>question/submitTest/<?php echo $xm->id ; ?>">
...
<?php } else{ ?>
  ...
  <div class="card card-primary card-outline" style="margin-top:20px; width: 100%;">    
      <div class="card-body">        
        ...
        <br>
        <form>
              <a class="btn btn-danger" href="<?= base_url() ?>question/delete_test_result/<?= $res->id; ?>/<?= $res->exm_id; ?>">Refresh and Enroll Exam again.</a>
          </form>
      </div>
  </div>
  <!-- Modal -->
