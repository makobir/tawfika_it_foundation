...
<script src="<?= base_url() ?>assets/typing/js/circletimer.min.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.7/highlight.min.js"></script>
<link href="<?= base_url() ?>assets/typing/css/circletimer.css" rel="stylesheet">
<link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/8.7/styles/default.min.css">
<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Pacifico|Raleway">
<script type="text/javascript" src="<?= base_url() ?>assets/typing/js/register_user.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/typing/js/authenticate_user.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/typing/js/store_performance.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/typing/js/load_menus.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/typing/js/logout.js"></script>
<style>
   @font-face
   {
   font-family : digital;
   src : url("<?= base_url() ?>assets/typing/font/DS-DIGIB.TTF");
   }
   .untyped
   {
   color:#505050 ;
...
<body onload="initialize();load_menus(1)">
   <div class = "container-fluid">
      <div id="timer_rohit" style ="position:absolute ; margin-top:10px ; margin-left:0px; text-align: center;">
         <label><span style="font-family:digital ; font-size:35px;">Time Left : </span>
         <span style="color:white;font-family:digital"><span style="font-size:55px;" id="time-elapsed">60</span>&nbsp&nbsp sec.</span></label>
      </div>
      <!------------------------------------------------------------------------------------------------------------------------------------------------------------>
      <div class = "row" style="margin-top:0px;">
         ...
         <div class="col-sm-2">
            <div id = "timer">
               <!-- space for the clock -->
               <div onclick="initialize()" id="restart" class="btn btn-primary" type="button" style="position:absolute ;font-size:15px; margin-top: 20px;" >Refresh&nbsp<span class="fa fa-repeat"></span></div>
            </div>
         </div>
         <div class="col-sm-12" style="margin-top:0px">
            <div class="form-group">
               <div class="card card-success">
                  ...
                  <div class="card-body">
                     <div id="display_space"style="border:0px solid ;height:200px;overflow:hidden">
   ...
   <script>
      // FOR TIMER 
              ...
              function initialize()
              {
                  ...
                  element.innerHTML = '<p id ="display" style="text-align:center ; font-size:30px ; line-height:170%; font-family:Times New Roman"> ' + to_display +' </p>';
