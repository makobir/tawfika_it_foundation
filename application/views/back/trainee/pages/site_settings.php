<?php
    $pro = $this->Authenticator_model->setting_data(); ?>
  ...
  <div class="nav-tabs-custom">
    <div class="tab-content">
      ...
      <!-- /.tab-pane --><!-- /.tab-pane -->
        ...
        <form method="post" action="<?php echo base_url(); ?>institute/update_logo" <?php echo form_open_multipart('upload/do_upload');?>         <div class="form-group col-sm-2">
                    <img style="height: 40px;" src="<?php echo base_url(); ?>upload/user/<?php echo $this->session->userdata('userfile')?>" class="img-responsive">
                </div> 
                <div class="form-group col-sm-6">
