...
<script type="text/javascript">
  if(document.getElementById("testName").checked) {
   ...
   <div class="card card-primary card-outline " style="padding: 10px 20px; width:100%;">
      ...
      <!-- /.box-header -->
      <div class="card-body">
        <form style="text-align: ; border: 1px" method="post" action="<?php echo base_url(); ?>super_admin/add_question_info" >
            ...
            <!--Form  Start here-->            
              ...
              if($exm_id == '') { ?>
                ...
                <?php }else{ ?>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                       <a class="btn btn-default" href="<?= base_url() ?>super_admin/question"><i class="fa fa-plus"></i> New Subject </a>
                    </div>
                 </div>
                <?php } ?>
                <div class="col-sm-12">
