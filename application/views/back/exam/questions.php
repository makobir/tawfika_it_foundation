...
<script type="text/javascript">
  ...
  <div class="card card-primary" style="width: 100%;">
    <div class="card-body">                    
       <form method="post" action="<?= base_url() ?>super_admin/goque">
      <div class="row"> 
        <div class="col-sm-4">                    
        ...
        <table class="table table-striped table-bordered table-hover datatable">
         ...
         // $questions = $this->Super_admin_model->questions();
          ...
          <tr>
            ...
            <?php } } ?>
            <td>
              <a class="btn btn-default" title="Edit" href="<?php echo base_url().'super_admin/edit_question/'.$questions->id; ?>"> <i class="fa fa-edit" ></i></a>

               <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?php echo $questions->id ?>"><i class="fa fa-trash"></i></button> 
<!-- 
              <a  class="btn btn-danger" title="Delete" href="<?php echo base_url().'super_admin/deleteQuestion/'.$questions->xmid.'/'.$questions->id; ?>"> <i class="fa fa-trash"></i></a> -->
            </td>
          </tr>
        <?php } ?>
        <?php }else{ ?>
