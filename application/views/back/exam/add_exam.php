   ...
   <div class="box box-solid " style="padding: 10px 20px">
      ...
      <div class="box-body no-padding">
         <div class="table-responsive" style="padding-top: 20px">
            <!--Form  Start here--> 
               <div class="col-sm-3">
                  <form method="post" action="<?php echo base_url(); ?>super_admin/add_exam_info" >
                    ...
                    <div class="form-group">
                       ...
                       <input type="text" name="ques_limit" class="form-control" placeholder="50" required="required">
                    </div>
                    <div class="form-group">
                       <label> Duration </label>
                       <input type="text" name="duration" class="form-control" placeholder="30" required="required">
                    </div>
                    <div class="form-group">
                       <label> Held On (Date )</label>
                       <input type="text" name="helddate" class="form-control" placeholder="31-12-2020" required="required">
                    </div>
                    <div class="form-group">
                       <label> Held at (Time) </label>
                       <input type="text" name="heldtime" class="form-control" placeholder="13:01:00" required="required">
                    </div>
                    <div class="form-group">
