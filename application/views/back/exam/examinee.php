...
<div class="card card-primary card-outline" style="width: 100%">
   ...
   <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
      <li class="nav-item">
         <a class="nav-link <?php if($title == 'Passed') { echo 'active'; }?>" id="custom-content-below-home-tab" data-toggle="pill" href="#new" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Passed</a>
      </li>
      <li class="nav-item">
         <a class="nav-link <?php if($title == 'Failed') { echo 'active'; }?>" id="custom-content-below-home-tab" data-toggle="pill" href="#f" role="tab" aria-controls="custom-content-below-home" aria-selected="true">Failed</a>
      </li>
      <li class="nav-item">
         <a class="nav-link <?php if($title == 'Certificate Issued') { echo 'active'; }?>"  id="custom-content-below-profile-tab" data-toggle="pill" href="#c" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Certificate Issued</a>
      </li>
   </ul>
   <div class="tab-content" id="custom-content-below-tabContent">
      <div class="tab-pane fade <?php if($title == 'Passed') { echo 'show active'; }?>" id="new" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                  ...
                  <tbody>                  
                        <?php                  
                         ...
                         if($this->Exam_model->formfilluped($center,$course,$year,$session,$month) != NULL){ 
                           ...
                           if ($t->eeid != NULL && $tt->mcq >= 30 &&  $cert_check == NULL ) {
                        ?>
                     <tr class="text-center">  
                        <td><?php echo $i; ?></td>
                        ...
                        <td>
                           ...
                           <div class="dropdown show btn-group">
                             <a class="btn btn-default" href="<?= base_url() ?>exam/marks_edit/<?php echo $t->regi; ?>">
      ...
      <div class="tab-pane fade <?php if($title == 'Failed') { echo 'show active'; }?>" id="f" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
         <form method="post" action="<?= base_url() ?>institute/formfillupnow">
         <div class="card-body">
            <div style="margin-top: 0px;">
                  ...
                  <tbody>                  
                        <?php                  
                         ...
                         if($this->Exam_model->formfilluped($center,$course,$year,$session,$month) != NULL){ 
                           ...
                           $tt = $this->Exam_model->exam_mark($t->regi);
                           $cert_check = $this->Exam_model->cert_check($t->regi);
                           if ($t->eeid != NULL && $tt->mcq <= 29 &&  $cert_check == NULL ) {
                        ?>
                     <tr class="text-center">  
                        <td><?php echo $i; ?></td>
                        <td> <img width="50px;" src="<?= base_url() ?>upload/user/<?php echo $t->trainee; ?>"></td>                
      ...
      <div class="tab-pane fade <?php if($title == 'Certificate Issued') { echo 'show active'; }?>" id="c" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
         <form method="post" action="<?= base_url() ?>institute/formfillupnow">
         <div class="card-body">
            <div style="margin-top: 0px;">
