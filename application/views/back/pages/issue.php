              ...
              <table id="example1" class="table table-bordered table-striped" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $value->date ?></td>
                    <td>
                      <?php if($value->print == 'Printed') { ?>
                        <span style="color: green; font-weight:bold;">Printed</span>
                        <a class="btn btn-default" href="<?= base_url() ?>certificates/print_certificate/<?php echo $value->regi; ?>">
