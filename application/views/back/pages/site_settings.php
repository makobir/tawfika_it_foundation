            ...
            <div class="row">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">                            
                            <form method="post" action="<?php echo base_url(); ?>super_admin/update_exam_cont" <?php echo form_open_multipart('upload/do_upload');?>  
                              <input type="hidden" name="id" value="<?= $this->session->userdata('icode'); ?>"> 
                              <div class="col-sm-12 " >                                  
                                    Signature Status : <b>  <?= $this->data['ex_ctrl_status'] ?> </b>
                              </div>     
                                <div class="form-group col-sm-6">
                                ...
                                <div class="form-group ">
                                    <div class="box-body pad">  
                                    <input class="btn btn-info" type="submit" value="Update now"> 
                                    <?php if($this->data['ex_ctrl_status'] == 'Active') { ?>
                                        <a class="btn btn-danger float-right"  href="<?= base_url() ?>super_admin/ex_ctrl_status_disable" > Disable Now</a> 
                                    <?php }else { ?>
                                        <a class="btn btn-success float-right" href="<?= base_url() ?>super_admin/ex_ctrl_status_enable" > Enable Now</a>
                                    <?php } ?> 
                                    </div>
                                </div> 
                            </form>
                ...
                <div class="col-sm-6">
                    <div class="card card-info">
                        ...
                        <div class="card-body">                            
                            <form method="post" action="<?php echo base_url(); ?>super_admin/update_chairman" <?php echo form_open_multipart('upload/do_upload');?>  
                              <input type="hidden" name="id" value="<?= $this->session->userdata('icode'); ?>"> 
                              <div class="col-sm-12 " >                                  
                                    Signature Status : <b>  <?= $this->data['chairman_status'] ?> </b>
                              </div>     
                                <div class="form-group col-sm-6">
                                    <img style="height: 40px;" src="<?php echo base_url(); ?>upload/logo/<?php echo $this->data['chairman'];?>" class="img-responsive">
                                </div> 
                                ...
                                <div class="form-group ">
                                    <div class="box-body pad">  
                                    <input class="btn btn-info" type="submit" value="Update now"> 
                                    <?php if($this->data['chairman_status'] == 'Active') { ?>
                                        <a class="btn btn-danger float-right"  href="<?= base_url() ?>super_admin/chairman_status_disable" > Disable Now</a> 
                                    <?php }else { ?>
                                        <a class="btn btn-success float-right" href="<?= base_url() ?>super_admin/chairman_status_enable" > Enable Now</a>
                                    <?php } ?> 
                                    </div>
                                </div> 
                            </form>
