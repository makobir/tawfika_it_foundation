   ...
   <div class="card-body">
      ...
      <div class="tab-content" id="custom-content-below-tabContent">
        ...
        <div class="card card-primary" style="margin-top: 20px; width: 100%;">
            <div class="card-body"> 
                <form method="post" action="<?php echo base_url() ?>super_admin/add_subject" <?php echo form_open_multipart('upload/do_upload'); ?> 
         ...
         <div class="tab-pane fade <?php if($title == 'Subject') { echo 'show active'; }?>" id="all" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
            ...
            <div class="card card-primary">
              <div class="card-body">                    
                 <form method="post" action="<?= base_url() ?>super_admin/subject">
                <div class="row"> 
                  <div class="col-sm-4">                    
                    <div class="form-group">
