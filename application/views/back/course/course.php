...
<div class="card card-primary card-outline" style="width: 100%">
   <div class="card-body">
      <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
         ...
         <li class="nav-item">
            <a class="nav-link <?php if($title == 'Edit Course') { echo 'active'; }?>"  id="custom-content-below-profile-tab" data-toggle="pill" href="#edit" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Edit Course</a>
         </li>
         <?php } ?>
      </ul>
      <div class="tab-content" id="custom-content-below-tabContent">
         ...
         <div class="tab-pane fade <?php if($title == 'New Course') { echo 'show active'; }?>" id="new" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">           
            ...
            <div class="card-body"> 
                <form method="post" action="<?php echo base_url() ?>super_admin/add_course"  <?php echo form_open_multipart('upload/do_upload'); ?> 
              ...
              <table id="example1" class="table table-bordered table-striped" >
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                       <a class="btn btn-default" href="<?= base_url() ?>super_admin/edit_course/<?php echo $value->id ?>">Edit</a>
                       <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $value->id ?>">Delete</button>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
         ...
         <?php if($title == 'Edit Course') {?> 
         <div class="tab-pane fade <?php if($title == 'Edit Course') { echo 'show active'; }?>" id="edit" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">           
            <div class="card card-primary" style="margin-top: 20px; width: 100%;">
            <div class="card-body"> 
                <form method="post" action="<?php echo base_url() ?>super_admin/update_course"  <?php echo form_open_multipart('upload/do_upload'); ?> 
                  <input type="hidden" id="srt" name="type" placeholder="get value on option select">
                  ...
                  <div class="formstyle">
                        <div class="row">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                     <label>Code</label>
                                     <input type="text" name="ccode"  class="form-control"  value="<?= $course->ccode; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-4">
                                  <div class="form-group">
                               ...
                               <div class="col-md-2">
                                  <div class="form-group">
                                     <label>Duration</label>
                                     <input type="text" name="duration" id="course_fee" class="form-control"  value="<?= $course->duration; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-2">
                                  <div class="form-group">
                                     <label>Course Fee</label>
                                     <input type="text" name="course_fee" id="course_fee" class="form-control"  value="<?= $course->course_fee; ?>" >
                                  </div>
                               </div>
                               <div class="col-md-2">
                                  <div class="form-group">
                                     <label>Certificate Fee</label>
                                     <input type="text" name="certificate_fee" id="certificate_fee" class="form-control" value="<?= $course->fee; ?>" >
                                  </div>
                               </div>
                             <div class="col-sm-12">
                                <div class="form-group">
                                   <label>Short Description  </label>
                                   <textarea  id="editor0" name="short" rows="5" cols="100" class="form-control"><?= $course->short; ?></textarea>
                                </div>
                             </div>
                             <div class="col-sm-12">
                                <div class="form-group">
                                   <label>Overview  </label>
                                   <textarea id="summernote" name="details" rows="10" cols="100" class="form-control"><?= $course->details; ?></textarea>
                                </div>
                             </div>
                              <div class="col-lg-4 col-sm-6 hidden-xs">
                                   <label>Course Photo  </label>
