<div class="row no-print" style="width: 100%">
  <div class="col-sm-12">                
    <div class="card card-primary" style="margin-top: 20px;">
      <div class="card-body">                    
        <form method="post" action="<?= base_url() ?>purchase/purchase_report">
        <div class="row">
          <div class="col-sm-2">
          ...
          <div class="col-sm-3">
            <select name="cat" class="form-control">
              ...
              <option value="load">Load Purchase </option>
              <option value="SIM">SIM Purchase </option>
          ...
          <div class="col-sm-3">              
            <div class="form-group">
              <button class="btn btn-info">View <b> Daily Report</b> </button>
            </div>
          </div>
        </div>                     
      </form>
    ...
    <div class="card card-primary">
      <div class="card-body">                    
        ...
        <div class="row">  
          ...
          <div class="col-sm-3">              
            <div class="form-group">
               <button type="submit" class="btn btn-info">View <b>Monthly Report</b> </button>
            </div>
          </div>
        </div>
        </form>
...
<?php   
    if($cat == 'load') { ?>
        ...
        <td colspan="4" style="padding: 10px"><h4 style="text-align: left;"> Report of :<b> <?php echo $group.' '.$cat ;  ?> Purchase </b> </h4></td>
      ...
      <?php
        $i =0; $bal =0;$com =0;  foreach ($this->Report_model->purchase_report($group,$cat,$date) as $key => $value) { 
        $i++; 
        $bal+= $value->price;
    ...
    <!-- ====================START SIM Purchase ========================================-->
      ...
      <tr style=" background: #d7d6d6;">
        <td colspan="5" style="padding: 10px;"><h4 style="text-align: left;"> Report of :<b> <?php echo $group.' '. $cat ;  ?> Purchase  </b> </h4></td>
      ...
      <?php
        $i =0; $bal =0;$com =0;$qua =0;  foreach ($this->Report_model->purchase_report($group,$cat,$date) as $key => $value) { 
        $i++; 
        $bal+= $value->price;
        $qua+= $value->qty;
        $com+= $value->commission;
...
<!-- ====================END CARD Slaes ========================================-->
    ...
    <?php } if ($cat=="" && $group == "") { ?>
      ...
      <?php
        $i =0; $lbal =0;$lcom =0; $cat ='load'; foreach ($this->Report_model->purchase_report($group,$cat,$date) as $key => $value) { 
        $i++; 
        $lbal+= $value->price;
 ...
 <table style="margin-top: 10px; width: 100%">
    <!-- ====================START SIM Purchase ========================================-->
      ...
      <?php
        $i =0; $sbal =0;$scom =0;$squa =0; $cat='SIM'; foreach ($this->Report_model->purchase_report($group,$cat,$date) as $key => $value) { 
        $i++; 
        $sbal+= $value->price;
        $squa+= $value->qty;
    ...
    <!-- ====================START CARD Purchase ========================================-->
      ...
      <?php
        $i =0; $cbal =0;$ccom =0;$cqua =0; $cat='Card';  foreach ($this->Report_model->purchase_report($group,$cat,$date) as $key => $value) { 
        $i++; 
        $cbal+= $value->price;
        $cqua+= $value->qty;
    ...
    <?php } if ($cat=="") { ?>
      ...
      <tr style="text-align: left; background: #d7d6d6;">
        <td style="padding: 10px;" colspan="4">Purchase Report of : <b> <?php echo $group ?> </b></td>
