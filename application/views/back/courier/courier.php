      ...
      <div class="col-sm-12">
         <div class="card card-primary">
            <div class="card-body">
               ...
               <form method="post" action="<?= base_url() ?>courier/send_to/<?= $id; ?>">
               <div class="row" >
                 <div class="col-sm-6">
                   <div class="form-group">
                        <label></label>
                     <select class="form-control" name="code" onchange="if (this.value) window.location.href=this.value">
                        <option value="0">Select Center</option>  
                        <?php foreach ($this->Super_admin_model->centers() as $key => $value) { ?>
                        <option <?php if($value->code == $id) {echo "selected";} ?> value="<?= base_url().'courier/send/'.$value->code; ?>"><?= $value->site_name; ?></option>
                        <?php } ?>
                     </select>
                   </div>
                 </div> 
