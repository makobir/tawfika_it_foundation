...
/* * *****************Text.php**********************************
 * @product name    : EduZone Institute Management System 	
 * ********************************************************** */
...
public function sendsms($value='')
    ...
    //$phone = "017xxxxxxx,+88016xxxxxxx";
    $phone = "01911143338";
    $token = "18677c9556a641c202072e06285856fa";
    $message = "Kemon Acen";
    ...
    * ********************************************************** */
        ...
        if ($_POST) {          
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    error($this->lang->line('message_send_failed'));
    ...
    public function get_single_sms(){
       ...
       $this->load->view('sms/get-single-sms', $this->data);
    }
