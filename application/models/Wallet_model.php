...
function payment_info($id) {
  ...
  function recharge($data){
   ...
   public function charity_fund_balance() {
        $this->db->select('*');
        $this->db->from('charity_fund');
        $this->db->select_sum('amount');
        $query_result = $this->db->get();
        $result = $query_result->row();
        return $result;
...
//==================================== Super_admin Area ==============================================
   ...
   public function wallet_payments_all() {
    ...
    public function referral_wallet_balance() {
        $this->db->select('*');
        $this->db->from('wallet');
    ...
    public function starting_wallet_balance() {
        $this->db->select('*');
        $this->db->from('wallet');
        $this->db->where('type','Starting Balance');
        $this->db->where('status','Approved');
        $this->db->select_sum('amount');
        $query_result = $this->db->get();
        $result = $query_result->row();
    ...
    public function referral_continues_wallet_balance() {
        $this->db->select('*');
        $this->db->from('wallet');
        $this->db->where('type','referral_continues');
        $this->db->where('status','Approved');
        $this->db->select_sum('amount');
        $query_result = $this->db->get();
        $result = $query_result->row();
