...
jQuery(document).ready(function() {
	...
	jQuery(".isotope_filters.isotope-courses-streampage").append('<a href="#" data-filter="*" class="isotope_filters_button active">All1</a><a href="#" data-filter=".flt_55" class="isotope_filters_button">3 Months </a><a href="#" data-filter=".flt_43" class="isotope_filters_button">06 Months</a><a href="#" data-filter=".flt_57" class="isotope_filters_button">01 Years</a><a href="#" data-filter=".flt_52" class="isotope_filters_button">Others</a>');
});

jQuery(document).ready(function() {
	"use strict";
	THEMEREX_GLOBALS['ppp'] = 8;
	jQuery(".isotope_filters.portfolio-page-2-columns").append('<a href="#" data-filter="*" class="isotope_filters_button active">All2</a><a href="#" data-filter=".flt_34" class="isotope_filters_button">medical</a><a href="#" data-filter=".flt_32" class="isotope_filters_button">masonry</a><a href="#" data-filter=".flt_33" class="isotope_filters_button">english</a>');
});
...
jQuery(document).ready(function() {
	"use strict";
	THEMEREX_GLOBALS['ppp'] = 8;
	jQuery(".isotope_filters.portfolio-page-3-columns").append('<a href="#" data-filter="*" class="isotope_filters_button active">All3</a><a href="#" data-filter=".flt_34" class="isotope_filters_button">medical</a><a href="#" data-filter=".flt_32" class="isotope_filters_button">masonry</a><a href="#" data-filter=".flt_33" class="isotope_filters_button">english</a>');
});
...
jQuery(document).ready(function() {
	...
	jQuery(".isotope_filters.masonry-page-2-columns").append('<a href="#" data-filter="*" class="isotope_filters_button active">All4</a><a href="#" data-filter=".flt_34" class="isotope_filters_button">medical</a><a href="#" data-filter=".flt_32" class="isotope_filters_button">masonry</a><a href="#" data-filter=".flt_33" class="isotope_filters_button">english</a><a href="#" data-filter=".flt_35" class="isotope_filters_button">computer</a>');
});

jQuery(document).ready(function() {
	"use strict";
	THEMEREX_GLOBALS['ppp'] = 9;
	jQuery(".isotope_filters.masonry-page-3-columns").append('<a href="#" data-filter="*" class="isotope_filters_button active">All5</a><a href="#" data-filter=".flt_34" class="isotope_filters_button">medical</a><a href="#" data-filter=".flt_32" class="isotope_filters_button">masonry</a><a href="#" data-filter=".flt_33" class="isotope_filters_button">english</a><a href="#" data-filter=".flt_35" class="isotope_filters_button">computer</a>');
});
